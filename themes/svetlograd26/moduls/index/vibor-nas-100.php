            ...
            <div class="why_100_block_left">
              <div class="indoor_units">
                <div class="container_indoor_units_img_left">
                  <div>
                    <img src="<?php echo get_template_directory_uri();  ?>/images/icon1.png" alt="" class="indoor_units_img_left">
                  </div>
                </div>
              ...
              <div class="indoor_units">
                <div class="container_indoor_units_img_left">
                  <div>
                    <img src="<?php echo get_template_directory_uri();  ?>/images/icon3.png" alt="" class="indoor_units_img_left">
                  </div>
                </div>
            ...
            <div class="why_100_block">
              <div class="indoor_units">
                ...
                <div class="container_indoor_units_img_right">
                  <div>
                    <img src="<?php echo get_template_directory_uri();  ?>/images/icon4.png" alt="" class="indoor_units_img_right">
                  </div>
                </div>
              </div>
              <div class="indoor_units">
              ...
              <div class="indoor_units">
                ...
                <div class="container_indoor_units_img_right">
                  <div>
                    <img src="<?php echo get_template_directory_uri();  ?>/images/icon6.png" alt="" class="indoor_units_img_right">
                  </div>
                </div>
              </div>
            </div>
